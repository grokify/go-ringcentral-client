...
The main client SDK is in the [`engagedigital/engagedigital`](engagedigital) folder. The [`engagedigital/engagedigitalutil`](engagedigitalutil) folder provides a non-autogenerated helper function to instantiate the SDK:
...
1. [`engagedigital/examples`](examples) folder for usage. [`engagedigital/examples/simple_get`](engagedigital/examples/simple_get) includes a simple functions for a lot of the `GET` APIs.
1. [engagedigital/engagedigital/README.md](engagedigital/README.md) for SDK documentation.

## Documentation

[engagedigital/engagedigital/README.md](engagedigital/README.md)
