...
require (
	...
	github.com/grokify/go-scim-client v0.1.23
	github.com/grokify/goauth v0.23.0
	github.com/grokify/mogo v0.67.2
	github.com/grokify/spectrum v1.18.11
...
require (
	...
	github.com/grokify/gocharts/v2 v2.21.10 // indirect
