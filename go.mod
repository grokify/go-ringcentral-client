...
require (
	...
	github.com/grokify/go-scim-client v0.1.13
	github.com/grokify/goauth v0.17.3
	github.com/grokify/mogo v0.45.0
	github.com/grokify/spectrum v1.16.4
...
require (
	...
	github.com/grokify/gocharts/v2 v2.8.8 // indirect
