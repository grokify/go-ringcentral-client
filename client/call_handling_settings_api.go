...
@param ivrMenuId
@return IvrMenuInfo*/
func (a *CallHandlingSettingsApiService) RestapiV10AccountAccountIdIvrMenusIvrMenuIdGet(ctx context.Context, accountId string, ivrMenuId string) (IvrMenuInfo, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@param accountId
@return IvrPrompts*/
func (a *CallHandlingSettingsApiService) RestapiV10AccountAccountIdIvrPromptsGet(ctx context.Context, accountId string) (IvrPrompts, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* CallHandlingSettingsApiService Create IVR Prompts
...
@return PromptInfo*/
func (a *CallHandlingSettingsApiService) RestapiV10AccountAccountIdIvrPromptsPost(ctx context.Context, accountId string, localVarFile *os.File, localVarOptionals map[string]interface{}) (PromptInfo, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@param promptId
@return */
func (a *CallHandlingSettingsApiService) RestapiV10AccountAccountIdIvrPromptsPromptIdContentGet(ctx context.Context, accountId string, promptId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@param promptId
@return */
func (a *CallHandlingSettingsApiService) RestapiV10AccountAccountIdIvrPromptsPromptIdDelete(ctx context.Context, accountId string, promptId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@param promptId
@return PromptInfo*/
func (a *CallHandlingSettingsApiService) RestapiV10AccountAccountIdIvrPromptsPromptIdGet(ctx context.Context, accountId string, promptId string) (PromptInfo, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
