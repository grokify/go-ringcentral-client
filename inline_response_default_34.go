...
type InlineResponseDefault34 struct {

	// Canonical URI of a resource
	Uri string `json:"uri,omitempty"`

	// Information on a user home country
	HomeCountry []ParsePhoneNumberCountryInfo `json:"homeCountry,omitempty"`

	// Parsed phone numbers data
	PhoneNumbers []ParsePhoneNumberPhoneNumberInfo `json:"phoneNumbers,omitempty"`
