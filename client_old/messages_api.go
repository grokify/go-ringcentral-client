...
@return FaxResponse*/
func (a *MessagesApiService) RestapiV10AccountAccountIdExtensionExtensionIdFaxPost(ctx context.Context, accountId string, extensionId string) (FaxResponse, *http.Response, error) {
	var (
