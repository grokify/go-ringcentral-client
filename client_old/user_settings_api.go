...
@param body
@return NotificationSettings*/
func (a *UserSettingsApiService) UpdateSettings(ctx context.Context, accountId string, extensionId int32, body NotificationSettingsUpdateRequest) (NotificationSettings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
