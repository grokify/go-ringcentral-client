...
type GetAccountInfoResponseIntId struct {
	...
	//Operator   GetExtensionInfoResponse `json:"operator,omitempty"` //JCW REMOVE
	// Additional account identifier, developed and applied by the client
	PartnerId string `json:"partnerId,omitempty"`
	//ServiceInfo ServiceInfo `json:"serviceInfo,omitempty"`//JCW REMOVE
