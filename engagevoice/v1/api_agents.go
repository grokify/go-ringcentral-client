...
func (a *AgentsApiService) GetAgentGroups(ctx context.Context, accountId string) ([]AgentGroup, *http.Response, error) {
	var (
		...
		localVarReturnValue  []AgentGroup
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/admin/accounts/{accountId}/agentGroups"
...
func (a *AgentsApiService) GetAgents(ctx context.Context, accountId string, agentGroupId string) ([]Agent, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/admin/accounts/{accountId}/agentGroups/{agentGroupId}/agents"
	localVarPath = strings.Replace(localVarPath, "{"+"accountId"+"}", fmt.Sprintf("%v", accountId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"agentGroupId"+"}", fmt.Sprintf("%v", agentGroupId), -1)
